...
namespace Iwan.Server.Migrations
{
    ...
    [Migration("20220508081350_RemoveThumbnailImage")]
            ...
            modelBuilder.Entity("Iwan.Server.Domain.Products.Product", b =>
                {
                    ...
                    b.Property<DateTime>("LastResizeDate")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Iwan.Server.Domain.Users.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "db4867b8-5ace-432c-94a7-0215555afb51",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "5b0f0b86-6eb7-495f-a3a5-f82c7660ac3e",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEE38ePHCxU2AAnc6ZRuJTyFX1+rB+Gv6NeqvPjctItIEjHLBLDarEe6o0LRTs9DWbg==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "a9d8f9ec-4ab5-49da-abe2-b3e558f5216d",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "2a8d4609-062b-4060-b2a0-6bdfae0d762b",
                            ConcurrencyStamp = "fdde02a9-c02c-4a23-9632-4e91d6282e76",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "3d4ea48c-07be-4892-9efd-72e97681f62c",
                            ConcurrencyStamp = "d9904b39-f997-4dd5-bd8a-b261864ba744",
                            Name = "SuperAdmin",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserRole<string>", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = "db4867b8-5ace-432c-94a7-0215555afb51",
                            RoleId = "3d4ea48c-07be-4892-9efd-72e97681f62c"
                        });
                });
            ...
            modelBuilder.Entity("Iwan.Server.Domain.Catelog.CategoryImage", b =>
                {
                    ...
                    b.HasOne("Iwan.Server.Domain.Media.Image", "OriginalImage")
                        .WithMany()
