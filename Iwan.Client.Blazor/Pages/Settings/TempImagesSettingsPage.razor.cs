...
{
    public partial class TempImagesSettingsPage
    {
        protected bool busy = false;
        protected TempImagesSettingsDtoValidator _validator;
        protected TempImagesSettingsDto _settings = new();
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            _settings = await SettingsService.GetTempImagesSettingsAsync();
        ...
        protected async Task UpdateSettingsAsync()
        {
            ...
            Snackbar.Add(Localize(LocalizeKeys.TempImagesSettingsUpdated), Severity.Success);
        }
