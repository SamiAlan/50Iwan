...
{
    public partial class RealTimeResizingCompositionsImagesJob : IDisposable
    {
        ...
        protected override void OnInitialized()
        {
            ...
            MessagingCenter.Subscribe<RealTimeEventsCenter>(this, ServerMessages.ResizingCategoriesImagesJobEnded, (_) => ResizingCategoriesImagesJobEnded());
        }
