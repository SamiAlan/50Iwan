...
{
    public partial class EditProductImagesSettings
    {
        private ProductsImagesSettingsDtoValidator _validator;

        protected ProductsImagesSettingsDto _settings = new();
        ...
        protected override void OnParametersSet()
        {
            ...
            if (ImagesSettings != null)
                _settings = ImagesSettings.MapToProductsSettingsDto();
        }
        ...
        protected async Task UpdateSettingsAsync()
        {
            ...
            Snackbar.Add(Localize(LocalizeKeys.ProductsImagesSettingsUpdated), Severity.Success);
        }
        ...
        protected async Task StartResizingJobAsync()
        {
            ...
            try
            {
                await BackgroundJobsService.StartResizingProductsImagesAsync();
            }
            catch (UnAuthorizedException e)
            {
