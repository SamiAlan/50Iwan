...
{
    public partial class EditCompositionImagesSettings
    {
        private CompositionsImagesSettingsDtoValidator _validator;

        protected CompositionsImagesSettingsDto _settings = new();
        ...
        protected override void OnParametersSet()
        {
            ...
            if (ImagesSettings != null)
                _settings = ImagesSettings.MapToCompositionsSettingsDto();
        }
        ...
        protected async Task UpdateSettingsAsync()
        {
            ...
            Snackbar.Add(Localize(LocalizeKeys.CategoriesImagesSettingsUpdated), Severity.Success);
        }
        ...
        protected async Task StartResizingJobAsync()
        {
            ...
            try
            {
                await BackgroundJobsService.StartResizingCompositionsImagesAsync();
            }
            catch (UnAuthorizedException e)
            {
