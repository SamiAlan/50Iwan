...
{
    public partial class EditCategoryImagesSettings
    {
        private CategoriesImagesSettingsDtoValidator _validator;

        protected CategoriesImagesSettingsDto _settings = new();
        ...
        protected override void OnParametersSet()
        {
            ...
            if (ImagesSettings != null)
                _settings = ImagesSettings.MapToCategoriesSettingsDto();
        }
        ...
        protected async Task StartResizingJobAsync()
        {
            ...
            try
            {
                await BackgroundJobsService.StartResizingCategoriesImagesAsync();
            }
            catch (UnAuthorizedException e)
            {
