...
{
    public partial class EditSliderImagesSettings
    {
        private SlidersImagesSettingsDtoValidator _validator;

        protected SlidersImagesSettingsDto _settings = new();
        ...
        protected override void OnParametersSet()
        {
            ...
            if (ImagesSettings != null)
                _settings = ImagesSettings.MapToSlidersImagesSettingsDto();
        }
        ...
        protected async Task UpdateSettingsAsync()
        {
            ...
            Snackbar.Add(Localize(LocalizeKeys.SliderImagesSettingsUpdated), Severity.Success);
        }
        ...
        protected async Task StartResizingJobAsync()
        {
            ...
            try
            {
                await BackgroundJobsService.StartResizingSliderImagesAsync();
            }
            catch (UnAuthorizedException e)
            {
