...
{
    public partial class HeaderSectionEditor
    {
        protected EditHeaderSectionDto _headerSection = new();
        protected ServerValidation _serverValidator;
        protected bool busy;

        [Parameter] public HeaderSectionDto HeaderSection { get; set; }
        ...
        protected override void OnParametersSet()
        {
            if (HeaderSection != null)
                _headerSection = HeaderSection.MapToEditHeaderSectionDto();
        ...
        protected async Task UpdateSectionAsync()
        {
            ...
            try
            {
                _headerSection = (await PagesService.EditSectionAsync(_headerSection)).MapToEditHeaderSectionDto();
            }
            ...
            catch (ServiceException e)
            {
                if (!e.Errors.Any())
                    ...
                    _serverValidator.DisplayErrors(e.Errors.ToProperValidationObject(_headerSection));
                return;
            }
            finally
            {
            ...
            Snackbar.Add(Localize(LocalizeKeys.HeaderSectionUpdated), Severity.Success);
        }
